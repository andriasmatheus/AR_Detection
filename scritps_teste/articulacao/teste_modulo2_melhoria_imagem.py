...
# Caminho para o diretório de vídeos
frame_skip = 3  # Processar 1 frame a cada 3
frame_count = 0
...
for root, dirs, files in os.walk(train_path):
    ...
    for file in files:
        ...
        window_width, window_height = 1280, 720  # Reduzir resolução para melhorar o desempenho
                ...
                for box in boxes:
                    ...
                    if results_pose.pose_landmarks:
                        ...
                        for landmark in landmarks:
                            ...
                            x = int(landmark.x * person_image.shape[1])
                            y = int(landmark.y * person_image.shape[0])
                            cv2.circle(person_image, (x, y), 5, (0, 0, 255), -1)

                    # Ajustar as dimensões da imagem redimensionada da pessoa para se ajustar à área da caixa delimitadora
                    person_image_resized = cv2.resize(person_image, (x2 - x1, y2 - y1))
